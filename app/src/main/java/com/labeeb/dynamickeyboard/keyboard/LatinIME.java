...
import com.labeeb.dynamickeyboard.keyboard.UserDictionary;
...
//        mVoiceRecognitionTrigger = new VoiceRecognitionTrigger(this);
    ...
    private void setNotification(boolean visible) {
        ...
        if (visible && mNotificationReceiver == null) {
            ...
            String title = "Show "+getApplicationContext().getString(R.string.app_name);
...
//                .obtainMessage(MSG_UPDATE_SHIFT_STATE), 300);
    ...
    private void onOptionKeyPressed() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            ...
            // in Android O.
            Intent intent = new Intent(getApplicationContext(), LatinIMESettings.class);
...
//            }
            Intent intent = new Intent(getApplicationContext(), InputLanguageSelection.class);
            intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
            startActivity(intent);
